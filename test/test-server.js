...
describe('Recipes', function() {
  ...
  it('should list recipes on GET', function() {
    ...
    return chai.request(app)
      ...
      .then(function(res) {
        ...
        // because we create sample items on app load
        ...
        res.body.forEach(function(item) {
          ...
          item.ingredients.forEach(function(ingredient){
              ...
              ingredient.length.should.be.at.least(1); 
          });
        });
      });
  });
  ...
  it('should add a recipe on POST', function() {
    const newItem = {name: 'tea', ingredients: ['water', 'tea bag']};
    return chai.request(app)
      .post('/recipes')
      .send(newItem)
      .then(function(res) {
  ...
  // *******  DELETE  *************
  //  1. GET receipes items so we can get ID of one
  //  to delete.
